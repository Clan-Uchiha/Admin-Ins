  ...
  return (
      ...
      <div className='flex items-center justify-center w-'>
        <div className="verification-form w-[60%]">
          <h2 className='text-black font-bold text-2xl flex justify-center pt-5'>User Verification :</h2>
          <div className="user-details p-12 text-lg m-2 flex flex-col gap-4 text-white rounded-xl font-semibold">
            ...
            <div className='flex flex-row justify-between pt-6 text-black'>
              <label className='flex items-center'>Title:</label>
              <input className='rounded-full py-2 focus:border-none border focus:ring-2' type="text"/>
              <label className='flex items-center'>Description:</label>
              <input className='rounded-full py-2 focus:border-none border shadow focus:ring-2' type="text"/>
            </div>
          </div>
          ...
          {isAllVerified ? (
            <div className="verification-success flex flex-col items-center">
              ...
              <Link href={`/certificateGen`}>
                <button className="bg-cyan-800 text-white px-6 py-4 rounded-xl shadow-lg font-bold my-2 hover:scale-105 hover:bg-cyan-800/50 transition-all hover:text-white">Generate & Send Certificate</button>
              </Link>
            </div>
          ) : (
